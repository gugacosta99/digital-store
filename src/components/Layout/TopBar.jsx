...
const TopBar = ({ fullSidebar, setFullSidebar }) => {
    ...
    return (
        <div className="topBar w-full h-20 flex justify-between items-center shadow-md">
            <div className="flex left-side ml-4">
                ...
                >
                    <div className={`w-8 h-0.5 bg-blue-900 ${fullSidebar && "transform rotate-45 translate-y-2.5"}`}></div>
                    <div className={`w-8 h-0.5 bg-blue-900 ${fullSidebar && "opacity-0"}`}></div>
                    <div className={`w-8 h-0.5 bg-blue-900 ${fullSidebar && "transform -rotate-45 -translate-y-2.5"}`}></div>
                </button>
            ...
            <div className="right-side mr-14">
                ...
                <button className="ml-4">LO</button>
            </div>
        </div>
    );
};
